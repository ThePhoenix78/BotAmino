...
class Client(Callbacks, SocketHandler):
    def __init__(
        ...
        self.active_live_chats: set[str]
    def parse_headers(self, data: str | None = None, type: str | None = None) -> dict[str, str]: ...
    def start_channel(self, comId: int, chatId: str, channelType: int) -> None: ...
    def end_channel(self, comId: int, chatId: str) -> None: ...
    def join_channel(self, comId: int, chatId: str, joinType: int, channelType: int) -> None: ...
    def start_voice_chat(self, comId: int, chatId: str) -> None: ...
    def end_voice_chat(self, comId: int, chatId: str) -> None: ...
    def start_avatar_chat(self, comId: int, chatId: str) -> None: ...
    def end_avatar_chat(self, comId: int, chatId: str) -> None: ...
    def start_video_chat(self, comId: int, chatId: str) -> None: ...
    def end_video_chat(self, comId: int, chatId: str) -> None: ...
    def start_screen_room(self, comId: int, chatId: str) -> None: ...
    def end_screen_room(self, comId: int, chatId: str) -> None: ...
    def join_voice_chat(self, comId: int, chatId: str) -> None: ...
    def join_avatar_chat(self, comId: int, chatId: str) -> None: ...
    def join_video_chat(self, comId: int, chatId: str) -> None: ...
    def join_screen_room(self, comId: int, chatId: str) -> None: ...
    def fetch_channel(self, comId: int, chatId: str) -> None: ...
    ...
    def join_community(self, comId: int, invitationId: str | None = None) -> Literal[200]: ...
    def request_join_community(self, comId: int, message: str | None = None) -> Literal[200]: ...
    def leave_community(self, comId: int) -> Literal[200]: ...
    def flag_community(self, comId: int, reason: str, flagType: int, isGuest: bool = False) -> Literal[200]: ...
    def edit_profile(
        self,
