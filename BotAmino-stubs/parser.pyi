...
def from_array_group(text: str, dtype: Type[Sequence[Any]]) -> Any: ...
def from_boolean_group(text: str, dtype: type) -> Any: ...
def from_list_group(text: str, dtype: Type[Iterable[Any]]) -> Any: ...
def from_literal_group(text: str, dtype: type) -> Any: ...
def from_mapping_group(text: str, dtype: Type[Mapping[Any, Any]]) -> Any: ...
def from_numeric_group(text: str, dtype: type) -> Any: ...
def from_text_group(text: str, dtype: type) -> Any: ...
def from_custom_group(text: str, dtype: type) -> Any: ...

class GroupInfo(NamedTuple):
    dtypes: Tuple[type, ...]
    converter: Callable[[str, type], Any]
...
def bind_callback(callback: Callable[..., Any], data: Parameters, arguments: List[Argument]) -> Any: ...
