...
class SocketHandler:
    ...
    def __init__(self, socket_trace: bool = False, debug: bool = False) -> None:
        ...
        self.debug: bool
        self.active: bool
        self.socket: WebSocketApp | None
        self.socket_thread: Thread | None
        self.reconnectTime: int
    ...
    def handle_message(self, ws: WebSocket, data: str) -> None: ...
...
class Callbacks:
    ...
    def handle_message(self, ws: WebSocket, data: bytes | str) -> None: ...
    def resolve(self, data: bytes | str) -> None: ...
